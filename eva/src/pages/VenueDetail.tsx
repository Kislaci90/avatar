...
import {type GetVenueResult, getSurfaceTypeColor} from "../services/venues.ts";
                                ...
                                {activeTab === 0 && (
                                    <Box>
                                        ...
                                        <Grid container spacing={2}>
                                            {data.getVenue.properties.map((property, index) => (
                                            ...
                                            {data.getVenue.location.amenities.map((amenity, index) => (
                                                <Grid size={{xs: 12, sm: 4, md: 3}} key={index}>
                                                    <Paper elevation={0} sx={{
                                                        p: 3,
                                                        border: `1px solid ${theme.palette.divider}`,
                                                        ...
                                                        {locationPropertyIconMap[amenity] || null}
                                                        <Typography variant="body2" fontWeight={600}
                                                                    color="primary">
                                                            {amenity}
                                                        </Typography>
